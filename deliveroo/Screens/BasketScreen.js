          ...
          {Object.entries(groupedItemsInBasket).map(([key, items]) => (
            ...
            >
              ...
              <TouchableOpacity>
                ...
                <View className="p-6 bg-white mt-5 space-y-4"  >
                    ...
                    <View className="flex-row justify-between"  >
                        ...
                        <Text className="text-black font-extrabold" >${basketTotal + 5.99}</Text>
                    </View>

                    <TouchableOpacity  onPress={()=>navigation.navigate('Preparing')} className="rounded-lg bg-[#00CCBB] p-4" >
                        <Text className="text-center  color-white font-extrabold text-lg" >Place Order</Text>
                    </TouchableOpacity>
